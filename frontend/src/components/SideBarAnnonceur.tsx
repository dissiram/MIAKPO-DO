      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <span className="font-semibold text-gray-700 text-lg">Abalo Afi</span>
          </div>
        </div>

        <Link to="/cvEdit">
          <button className="bg-blue-600 text-white font-semibold rounded-xl py-2 px-4 mb-8 hover:bg-blue-700 transition w-full shadow">+ Nouvelle annonce</button>
        </Link>

        <div className="mb-8">
          <div className="uppercase text-xs text-gray-400 font-bold tracking-widest mb-2 pl-2">Navigation</div>
          <nav className="flex flex-col gap-2">
            <Link to="/cv" className={`flex items-center gap-3 py-2.5 px-4 rounded-xl transition-all duration-150 ${isActive('/cv') ? 'bg-blue-100 text-blue-700 font-bold shadow' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'}`}> <FaFolderOpen size={22} color={iconColor(isActive('/cv'))} /> <span>Mes annonces</span> </Link>
        ...
        <div className="mb-8">
          ...
          <nav className="flex flex-col gap-2">
            <Link to="/dashboard" className={`flex items-center gap-3 py-2.5 px-4 rounded-xl transition-all duration-150 ${isActive('/dashboard') ? 'bg-blue-100 text-blue-700 font-bold shadow' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'}`}> <FaFolderOpen size={22} color={iconColor(isActive('/dashboard'))} /> <span>Postulants</span> </Link>
            ...
            <Link to="/reports" className={`flex items-center gap-3 py-2.5 px-4 rounded-xl transition-all duration-150 ${isActive('/reports') ? 'bg-blue-100 text-blue-700 font-bold shadow' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'}`}> <FaChartBar size={22} color={iconColor(isActive('/reports'))} /> <span>Rapports</span> </Link>
          </nav>
        </div>
